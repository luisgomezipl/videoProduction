...
|  Emanuel  | 			Emanuel	Quaresma Moreira da Silva    	 |
...
Examples:
 ...
 | Gabriel |   Polytechnic of Leiria - ESTG      | Guest assistant 	  | Lecturing of practical classes of curricular units 		|
...
Examples:
 ...
 |		   |									 |						|  the television to Android smartphones/tablets. This equipment is    |				  |         |									  |						 |    connected to the television and the router on-site ad conveys the |
